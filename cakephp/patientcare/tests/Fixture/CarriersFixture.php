...
class CarriersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'carrier_code' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-06-14 15:42:58',
                'modified' => '2020-06-14 15:42:58',
            ],
        ];
        parent::init();
    }
