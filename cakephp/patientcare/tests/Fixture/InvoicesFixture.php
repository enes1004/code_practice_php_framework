...
class InvoicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'services' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'due' => '2020-06-14',
                'created' => '2020-06-14 15:43:21',
                'modified' => '2020-06-14 15:43:21',
            ],
        ];
        parent::init();
    }
